...
export let KEY_CODE_MAP: { [keyCode: number]: KeyCode } = new Array(230)
export let INVERSE_KEY_CODE_MAP: KeyCode[] = new Array(KeyCode.MAX_VALUE)
;(function() {
...
class StandardKeyboardEventInternal implements IKeyboardEvent {
  readonly _standardKeyboardEventBrand = true
...
export { StandardKeyboardEventInternal as StandardKeyboardEvent }

declare global {
  export type StandardKeyboardEvent = StandardKeyboardEventInternal
}
